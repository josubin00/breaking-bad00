...
(function($, window, document, Math, undefined) {
    ...
    $.fn.multiscroll = function(options) {
        ...
        if (options.navigation) {
            $('#music_track').append('<div id="multiscroll-nav"><ul></ul></div>');
            nav = $('#multiscroll-nav');
        ...
        */
        ...
        function silentScroll(){
            ...
            if(options.css3){
                ...
                $('.ms-left').css('top', -$('.ms-left').find('.ms-section.active').position().top+200 );
                $('.ms-right').css('top', -$('.ms-right').find('.ms-section.active').position().top+200 );
            }
        }
        ...
        */
        function setBodyClass(){
            ...
            $('#music_track')[0].className = $('#music_track')[0].className.replace(classRe, '');

            //adding the current anchor
            $('#music_track').addClass('ms-viewing-' + text);
        }
